      ...
      <footer class="w-full bg-black">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-2 lg:grid-cols-4 lg:gap-8 gap-12 pt-14 pb-20 max-w-md mx-auto md:max-w-xl lg:max-w-full">
            ...
            <div class="block">
              <h4 class="text-xl text-white font-bold mb-7">Quick Links</h4>
              <ul class="text-lg  transition-all duration-500">
                <li class="mb-6">
            ...
            <div class="block">
              <h4 class="text-xl text-white font-bold mb-7">Social Media</h4>
              <ul class="text-lg  transition-all duration-500">
                <li class="mb-6">
                  <a href="javascript:;" class="flex items-center space-x-2 text-gray-400 hover:text-white">
                  <a
                  href="javascript:;"
                  class="w-9 h-9 mr-2 rounded-full border border-gray-700 flex justify-center items-center hover:border-indigo-600"
                >
                  <svg
