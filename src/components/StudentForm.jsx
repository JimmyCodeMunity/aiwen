  ...
  const createStudent = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://aiwbackend.vercel.app/api/v1/student/createstudent",
        {
          fullname,
          course,
          college,
    ...
    <div>
      {loading ? (
        <div className="flex justify-center items-center h-full">
          <div className="text-black">Please wait as we create your account...</div>
        </div>
      ) : success ? (
        ...
        <div className="bg-transparent rounded shadow-lg p-4 px-4 md:p-8 mb-6">
          <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
            <div className="text-gray-600">
              <p className="font-bold text-lg ">Student Details</p>
