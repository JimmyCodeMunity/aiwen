      ...
      <div class="relative">
        <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
          <div class="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 ">
            <div>
              <div>
                <span class="flex h-12 md:mt-0 mt-5 w-12 items-center justify-center rounded-xl bg-pink-500">
          ...
          <div class="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 lg:col-start-2">
            <div>
              ...
              <div class="mt-6">
                ...
                <div class="mt-6">
                  <a
                    class="inline-flex rounded-lg bg-pink-600 px-4 py-1.5 text-white font-semibold leading-7 text-black shadow-sm ring-1 ring-yellow-600 hover:bg-pink-700 hover:ring-pink-700"
                    href="/login"
                  >
                    Learn More
                  </a>
