    ...
    <div class="bg-white">
      ...
      <section class="text-center py-12 px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8 animate-fadeIn">
          <div class="p-4 shadow-lg rounded-lg bg-pink-200 hover:bg-green-200 transition-colors">
      ...
      <section class="bg-gray-100 py-12 px-4">
        ...
        <form class="max-w-2xl mx-auto mt-8 space-y-8">
          ...
          <button type="submit" class="w-full bg-black text-white py-3 rounded-lg shadow-lg hover:bg-green-600 transition-colors">Send Message</button>
        </form>
      </section>
      <section class="text-center py-12 px-4">
